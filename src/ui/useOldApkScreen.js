...
function useOldApkScreen(ui) {
    ...
    label.setStyleSheet('font-size: 20px; font-family: "Segoe UI", serif; font-weight: 500; color: white; margin: 0;');
    label.setText('The YouTube APK already exists in the revanced folder.\nDo you want to use it?');
